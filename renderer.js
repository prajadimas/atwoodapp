...
$(document).ready(function () {
  ...
  // Open tab for display GLB experiment
  $("#menutab-glb").click(function (evt) {
    $("#menutab-glbb").removeClass("active");
    $("#menutab-glb").addClass("active");
  });
  // Open tab for display GLBB experiment
  $("#menutab-glbb").click(function (evt) {
    $("#menutab-glb").removeClass("active");
    $("#menutab-glbb").addClass("active");
  });
